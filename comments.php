...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="comment-navigation" role="navigation">
			<h1 class="screen-reader-text"><?php _e( 'Comment navigation', 'refpress' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'refpress' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'refpress' ) ); ?></div>
	...
	<?php if ( ! \DevHub\is_parsed_post_type() && comments_open() ) : ?>
		<p id="add-user-note" style="display:none;"><a href=""><?php _e( 'Leave a reply', 'refpress' ); ?></a></p>
