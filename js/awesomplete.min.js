...
(function() {
    function m(a, b) {
        for (var c in a) {
            var g = a[c], e = this.input.getAttribute("data-" + c.toLowerCase());
            this[c] = "number" === typeof g ? parseInt(e) : !1 === g ? null !== e : g instanceof Function ? null : e;
            this[c] || 0 === this[c] || (this[c] = c in b ? b[c] : g);
        }
    }
    function d(a, b) {
    ...
    var f = function(a, b) {
        ...
        d.bind(this.input, {
            ...
            keydown: function(a) {
                var b = a.keyCode;
                if (c.opened) if (13 === b && c.selected) a.preventDefault(), c.select(); else if (27 === b) c.close(); else if (38 === b || 40 === b) a.preventDefault(), 
                c[38 === b ? "previous" : "next"]();
            }
        });
        d.bind(this.input.form, {
        ...
        d.bind(this.ul, {
            mousedown: function(a) {
                ...
                if (b !== this) {
                    ...
                    b && 0 === a.button && (a.preventDefault(), c.select(b, a));
                }
            }
        });
    ...
    f.prototype = {
        ...
        "goto": function(a) {
            ...
            d.fire(this.input, "awesomplete-highlight");
        },
        select: function(a, b) {
            if (a = a || this.ul.children[this.index]) {
                ...
                c || (this.replace(a.textContent), this.close(), d.fire(this.input, "awesomplete-selectcomplete"));
            }
        },
        evaluate: function() {
            var a = this, b = this.input.value;
            b.length >= this.minChars && 0 < this._list.length ? (this.index = -1, this.ul.innerHTML = "", 
            this._list.filter(function(c) {
                return a.filter(c, b);
    ...
    d.create = function(a, b) {
        var c = document.createElement(a), g;
        for (g in b) {
            var e = b[g];
            "inside" === g ? d(e).appendChild(c) : "around" === g ? (e = d(e), e.parentNode.insertBefore(c, e), 
            c.appendChild(e)) : g in c ? c[g] = e : c.setAttribute(g, e);
        }
        return c;
    };
    d.bind = function(a, b) {
